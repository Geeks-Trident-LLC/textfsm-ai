# textfsm_ai/generation/fallback.py

from typing import Optional

from .cleaner import clean_template
from .extractor import LLMRunResult
from .structured_extractor import StructuredResult, parse_from_response
...
def run(
    ...
    elif two_pass_result and two_pass_result.response:
        candidate_raw = two_pass_result.response
        base = two_pass_result
