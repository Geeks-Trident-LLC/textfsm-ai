...
#     # Simulate next day
#     monkeypatch.setattr(time, "strftime", lambda fmt: "2099-01-02" if fmt == "%Y-%m-%d" else "2099-01")
...
#     # Simulate next month
#     monkeypatch.setattr(time, "strftime", lambda fmt: "2099-02" if fmt == "%Y-%m" else "2099-02-01")
