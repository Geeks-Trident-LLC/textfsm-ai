...
from textfsm_ai.generation.generator import (
    GenerationResult,
    generate,
)
...
@patch("textfsm_ai.generation.generator.validate_template")
@patch("textfsm_ai.generation.generator.clean_template")
